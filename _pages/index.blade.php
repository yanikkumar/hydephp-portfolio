...
@section('content')
    <main id="content" class="px-8 py-12 mx-auto max-w-7xl">
        <header class="lg:mb-12 xl:mb-16">
            <div class="flex flex-wrap justify-center gap-6">
                <h1
                    class="mb-8 text-3xl font-extrabold leading-10 tracking-tight text-left text-gray-700 sm:leading-none md:mb-12 md:text-4xl md:text-left lg:text-5xl dark:text-gray-200">
