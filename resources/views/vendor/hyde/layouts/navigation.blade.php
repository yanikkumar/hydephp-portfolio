...
<nav aria-label="Main navigation" id="main-navigation"
    ...
    <div class="flex items-center flex-grow flex-shrink-0 text-gray-700 dark:text-gray-200">
        @include('hyde::components.navigation.navigation-brand')

        <div id="main-navigation-links"
            class="flex-grow w-full px-6 pt-3 mx-auto mt-3 border-t border-gray-200 x-uncloak-md md:flex md:flex-grow-0 md:items-center md:w-auto md:border-none md:mt-0 md:py-0 dark:border-gray-700"
            :class="navigationOpen ? '' : 'hidden'" x-cloak>
            <ul aria-label="Navigation links" class="justify-end md:flex-grow md:flex">
